...
var iOSTransformer = {
	...
	var normalizedKey = key.replace(/%newline%/gi, "");
        normalizedKey = normalizedKey.replace(/"/gi, '\\"');
        normalizedKey = normalizedKey.replace(/%([@df])/gi, '%$1');
        normalizedKey = normalizedKey.replace(/%s/gi, "%@");
